-- Migration: Add email_events table for granular tracking
-- Ejecutar DESPUÉS de migration-email-tracking.sql
...
CREATE INDEX IF NOT EXISTS idx_email_events_track_id ON email_events(track_id);
