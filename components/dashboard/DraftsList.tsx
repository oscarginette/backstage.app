    ...
    <>
      <div className="bg-white rounded-3xl border border-[#E8E6DF] p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-serif text-[#1c1c1c] mb-1">Borradores</h3>
          ...
          <button
            onClick={loadDrafts}
            className="p-2 rounded-xl border border-[#E8E6DF] text-gray-600 hover:bg-[#F5F3ED] transition-colors"
